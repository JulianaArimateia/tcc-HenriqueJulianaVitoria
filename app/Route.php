...
class Route extends Bootstrap
{
    ...
    protected function initRoutes()
    {
        ...
        //PagamentoControler
        $routes['estrutura'] = array('route' => '/estrutura', 'controller' => 'PagamentoController', 'action' => 'estrutura');
        $routes['pagamento'] = array('route' => '/pagamento', 'controller' => 'PagamentoController', 'action' => 'pagamento');
