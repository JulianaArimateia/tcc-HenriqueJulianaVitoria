...
class Route extends Bootstrap
{
    ...
    protected function initRoutes()
    {
        ...
        $routes['carrinho'] = array('route' => '/carrinho', 'controller' => 'indexController', 'action' => 'carrinho');
        $routes['favoritos'] = array('route' => '/favoritos', 'controller' => 'indexController', 'action' => 'favoritos');
